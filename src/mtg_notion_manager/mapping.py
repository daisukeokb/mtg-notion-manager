...
# Notion「MTG統率者DB」>「発売セット」の既存選択肢(2026-09-13 時点で実測、
# 2026-07-11 に「イニストラード：真紅の契り」をNotion側で手動追加・反映、
# 2026-08-26 に「イクサラン：失われし洞窟」をNotion側で手動追加・反映、
# 2026-09-12 に「久遠の終端」「霊気走破」「統率者（2017年版）」が既存選択肢に
# 存在することを実測確認しmapping.pyへ追記(実際にいつ追加されたかは未確認)、
# 2026-09-13 に「統率者マスターズ」をNotion側で手動追加・反映、
# 2026-09-15 に「統率者（2013年版）」が既存選択肢に存在することを実測確認し
# mapping.pyへ追記(実際にいつ追加されたかは未確認)。
